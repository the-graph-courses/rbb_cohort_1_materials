...
b. Now, incorporate the `fill` aesthetic, `aes(..., fill = malaria_variable)`, with `position = "fill"` within the histogram function to create a stacked histogram. This graph should show how the responses to this question differ at the various levels of the chosen continuous variable.
