...
![](images/gg_min_build_positions.png){width="634"}

### Histograms

You can change the position adjustment within `geom_histogram()`.

Possible values for the argument **position** in `geom_histogram()` are `“identity”`, `“stack”`, `“dodge”`, and `"fill"`. Default value is `“stack”`.
...
ggplot(ir_clean, 
  ...
  theme_classic() # built-in ggplot theme
```
