...
subtitle: "Position adjustments and faceting"
...
Today we will be looking at individual recode (IR) data from **Nigeria (2018)**.
...
ir_raw <- 
  haven::read_dta(here("data/NGIR7BFL_mini.DTA"),
                  col_select = c(
                    # basic information
                    v006, v007, v009, v010, v012, v013, v022, v024, v025, v106, v130, v190,                     # fertility and reproductive timing
...
## Distributions with historgrams and barplots

```{r}
# histogram age first birth
ggplot(ir_clean, aes(age_first_birth)) +
...
ggplot(ir_clean, aes(age_first_birth, fill = urban_rural)) +  
...
```{r}
# Map fill to sex
ggplot(ir_clean, aes(age_first_birth, fill = highest_educ)) +
