...
-   The example uses the motorcycle accdients dataset from Colombia, but you should use the India TB dataset.
-   Code echo is turned off in all code chuncks so that the finished product hides the source code, showing only the output.
...
## Road Injuries of Motorcyclists

This dataset provides information about deaths caused by motorcycle accidents in Medellín, a Colombian city. The data is sourced from medical and police certificates.
