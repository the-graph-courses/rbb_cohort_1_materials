...
5.  In the "rmd" sub-folder, the instructions for your exercise are outlined (these are the same instructions you see here).
...
The dataset provides information about deaths caused by motorcycle accidents in Medellín, a Colombian city. The data is sourced from medical and police certificates.
