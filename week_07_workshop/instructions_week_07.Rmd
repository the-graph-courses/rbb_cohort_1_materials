...
The due date for the assignment is Friday, June 23rd at 23:59 PM UTC+1. Contact the instructors if you need an extension.

# Steps for completing this assignment

To get started, you should download and look through the assignment folder.

1.  **First download the repo to your local computer.** Links to download the workshop code are on the assignment page of out R Basics and Beyond course [here](https://thegraphcourses.org/courses/r-basics-and-beyond-1/topics/workshop-7-7/lessons/assignment-workshop-7-5/).
