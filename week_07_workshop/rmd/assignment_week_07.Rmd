...
Now we will summarize costs by again, but this time use "nested"
grouping to grou the data by two variables: `age_group` and `sex`.
...
Using `esquisse`, keep only respondents who smoke and plot their average
total cost by age group. Make sure to choose an appropriate plot!
...
delay vs. the total costs, for all participants.
