...
You can view the sample report by clicking on the link below: [here](https://the-graph-courses.github.io/rbp_cohort_0_final_assessment/rmd/ng_example.html){target="_blank"}

To access the source code for this report, click [here](https://github.com/the-graph-courses/rbp_cohort_0_final_assessment/blob/main/rmd/ng_example.Rmd){target="_blank"}

You can also view some past student work here: 

# **Addendum 2: Grading Rubric**
...
Create at least four ggplot-based figures that are clear, informative, and aesthetically pleasing. You should also make sure to include appropriate titles and labels for your figures.
...
# **Addendum 3: Information about the DHS**
...
You can learn more about the DHS program and the various surveys they run by watching the following [video](https://www.youtube.com/watch?v=abP6xeb50D). The section from 2:33 to 3:20, as it provides information on the specific survey type whose data you will be using.

Several datasets (called recodes) are made available from each survey, including a household recode, men's recode and the women's recode (sometimes called the individual recode). This *individual/women's recode* dataset contain individual-level data on women aged 15 to 49 in the surveyed households. It will be the source data for your reports.

To hear more about the different recodes, you can watch the following [video](https://www.youtube.com/watch?v=BmiSDPebmgc)

# **Addendum 4: Help with choosing a topic**

To help guide your selection of a topic to write your report on, we recommend that you look through a few "Key Findings/Summary Reports" that DHS-participating countries have published. These reports highlight important findings and patterns from the surveys and should serve as inspiration for your own analysis. Links to a few examples can be found below:
